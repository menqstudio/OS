...
**Last updated · Վերջին թարմացum:** 2026-07-27 (Phase 0 MERGED `b6c6712`; PR #31 rebased; rev-26 Architect design **RED** (2 P0 + 3 P1); rev-27 remediation submitted for re-audit; dependency-safe queue՝ i18n-parity gate + schema-migration test + security negative-test matrix + operator/user/troubleshooting guides, stacked on `chore/main-resync`).
