...
>
> Wave 3b-1B steps 1-4 landed (§4.10(a0) pre-accept open, §4.10(a)(b)(c) staging upload, §4.10(d) execute trigger, §4.10(e) reply re-framed into §4.6 — the four the sidecar names at `bridge/engine_sidecar.py:46-47`), the evidence-floor and prompt-forgery clusters are closed, and Phase 1's false round-trip tick is open again. Two Owner decisions are queued in docs/OWNER_ACTION_REQUIRED.md: the head-floor write principal (1b) and which half of rev-30 defines challenge_handle (1c).
>
