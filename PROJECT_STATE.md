...
> **✅ SETTLED — `main` is at `2f5197e`.** The only thing open is PR #92 on `fix-ci-counts`, the pull request that records it. Start from `docs/OWNER_ACTION_REQUIRED.md`, the one page that says what is blocked and on whom.
>
