...
|---|---|---|---|
| 🔨 Claude | Wave 3a — Receipt Protocol v1 **slice 1 (protocol core)** (T-014) — **PR #24** | `feat/wave-3a-receipt-protocol` @ `f5b6ffe` | 🔴 **RED / merge-blocked** — 2 RED rounds fixed in code (`aa4dc01`, `f5b6ffe`); **re-audit of `f5b6ffe` pending, no GREEN** |
| 📐 ChatGPT | — | — | — |
