...
>
> **Next:** Eighth audit: 27 of 29 marks are now independently confirmed. `T-030` (A-09) has a **Builder remediation ◑ 2026-08-18** — smuggle routes 2 and 3 closed with mutants, route 1 answered by a declared eight-leaf free-text register rather than a sweep; it needs an independent round, not another Builder pass. Open: T-035..T-039, T-033, T-034, T-023.
>
