...
**Last updated · Վերջին թարմացum:** 2026-07-27 (Phase 0 MERGED `b6c6712`; PR #31 rebased; rev-26 Architect design **RED** (2 P0 + 3 P1); rev-27 remediation submitted for re-audit; dependency-safe queue՝ App/Shell a11y + i18n polish (aria/role/tabIndex additive, routing unchanged, en/hy/ru 213 parity), stacked on `chore/main-resync`).
