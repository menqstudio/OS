...
_Last updated: 2026-07-27. Primary platform: Linux (Debian); also built/tested on Windows. Reflects the original 10 rounds of BroPS remediation **plus** the OS-monorepo governed-execution hardening (Waves 1–3a complete; Wave 3b-0 design merged; Wave 3b-1 in progress on PR #31/#32 — not merged, no production "Verified" yet). Live status: root [`NEXT_CHAT.md`](../../NEXT_CHAT.md) + [`config/current_state.json`](../../config/current_state.json)._
