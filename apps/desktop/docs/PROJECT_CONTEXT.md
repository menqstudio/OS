...
- **Owner:** Gev.
- **Related:** [PRINCIPLES.md](PRINCIPLES.md), [ARCHITECTURE.md](architecture/ARCHITECTURE.md), [MASTER_EXECUTION_ROADMAP.md](../../../MASTER_EXECUTION_ROADMAP.md), [DESIGN_SYSTEM.md](architecture/DESIGN_SYSTEM.md), [TERMINOLOGY.md](TERMINOLOGY.md).
