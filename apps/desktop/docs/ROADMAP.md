...
Status: Delivered (2026-07-19) — the desktop app runs on a real backend; the mock layer is gone. Schema at **v13**, `cargo test -p brops-core` GREEN (**69 tests**), CI green. *(Schema/test counts have since grown with the OS-monorepo security-remediation waves — see the root [`NEXT_CHAT.md`](../../../NEXT_CHAT.md).)*

- React + TypeScript frontend ✓ (Phase 2)
- **SQLite data core** ✓ — `src-tauri/core` schema (13 migrations), typed repositories, 69 tests
