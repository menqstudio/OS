export const en = {
  ...
  'settings.aiProviderHint': 'Read-only — set by the backend environment. Governed turns run behind the engine wall and carry a verified signed receipt; ungoverned providers do not.',
