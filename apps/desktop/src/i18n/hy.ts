...
export const hy: Record<DictKey, string> = {
  ...
  'action.copy': 'Պատճենել',
  'action.cut': 'Կտրել',
  'action.paste': 'Տեղադրել',
  'action.selectAll': 'Ընտրել ամբողջը',
  'action.windowFailed': 'Չհաջողվեց նոր պատուհան բացել',
  ...
  'home.askTitle': 'Հարցում Բրոյին',
  'home.emptyPriorities': 'Ակտիվ առաջնահերթություններ չկան',
  'home.emptyPrioritiesHint': 'Ակտիվ առաջադրանքներն այստեղ կհայտնվեն աշխատանքի ընթացքում։',
  'home.emptyApprovals': 'Սպասվող հաստատումներ չկան',
  'home.emptyApprovalsHint': 'Ձեր որոշմանը սպասող պաշտպանված գործողություններն այստեղ կհայտնվեն։',
  'home.emptyAgents': 'Ակտիվ գործակալներ չկան',
  'home.emptyAgentsHint': 'Ներկայումս աշխատող գործակալներն այստեղ կհայտնվեն։',
  'home.emptyProjects': 'Դեռ նախագծեր չկան',
  'home.emptyProjectsHint': 'Ձեր ստեղծած նախագծերն այստեղ կհայտնվեն։',
  'top.account': 'Հաշիվ',
  'a11y.skipToContent': 'Անցնել բովանդակությանը',
  'a11y.primaryNav': 'Հիմնական նավարկություն',
  'a11y.toolbar': 'Արագ գործողություններ',
};
