...
export const hy: Record<DictKey, string> = {
  ...
  'settings.aiProviderHint': 'Միայն ընթերցման — սահմանվում է backend-ի միջավայրով։ Governed քայլերն անցնում են engine-ի wall-ով և կրում են verified signed receipt; ungoverned մատակարարները՝ ոչ։',
