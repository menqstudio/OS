...
export const hy: Record<DictKey, string> = {
  ...
  'chat.blockedTitle': 'Կառավարվող քայլն արգելափակված է',
  'chat.blockedNext': 'Քայլն աշխատեց շարժիչի պատի հետևում, բայց չվերադարձրեց ստուգված ստացական, ուստի պատասխան չի ցուցադրվում։ Կարգավորե՛ք կառավարման սայդքարը (կամ ինքնաստուգե՛ք) և կրկին փորձե՛ք։',
