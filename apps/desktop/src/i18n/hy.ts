...
export const hy: Record<DictKey, string> = {
  ...
  'chat.deleteConversation': 'Ձնջել զրույցը',
  ...
  'action.delete': 'Ձնջել',
  'action.deleteDisabledSafety': 'Ձնջելը ժամանակավոր անջատված է անվտանգության համար — safe-delete / confirmation գալիս է T-011-ում։',
  'confirm.deleteTitle': 'Ձնջե՞լ այս տարրը։',
