...
export const ru: Record<DictKey, string> = {
  ...
  'settings.aiProviderHint': 'Только для чтения — задаётся окружением backend. Управляемые ходы проходят через стену движка и несут проверенную подписанную квитанцию; неуправляемые провайдеры — нет.',
