...
## Round 9 (2026-08-19, `main` @ `5cf9b8c`) — superseded by the tenth round

Moved out of [`AUDIT_LEDGER.md`](./AUDIT_LEDGER.md) on 2026-09-19 when the tenth round landed, for the
reason that file carries a byte ceiling: it is read at the start of every session. Nothing was
summarised on the way in, and every row carries the tenth round's verdict beside the Builder's claim.
