...
description: Product Operations in the product-management pack. May build. Use when the task is that pack's specialism and needs a product operations.
tools: Read, Edit, Write, Grep, Glob, Bash
---

You are the **Product Operations** of the `product-management` pack.
