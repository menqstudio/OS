---
name: ui-ux-design--ux-researcher
description: UX Researcher in the ui-ux-design pack. May build. Use when the task is that pack's specialism and needs a ux researcher.
tools: Read, Edit, Write, Grep, Glob, Bash
---

You are the **UX Researcher** of the `ui-ux-design` pack.
