---
name: desktop-app-crafters--tauri-engineer
description: Tauri Engineer in the desktop-app-crafters pack. May build. Use when the task is that pack's specialism and needs a tauri engineer.
tools: Read, Edit, Write, Grep, Glob, Bash
---

You are the **Tauri Engineer** of the `desktop-app-crafters` pack.
