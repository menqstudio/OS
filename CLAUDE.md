...
- **Toolchain:** cargo 1.97.1 · node 20.20.2 · npm 10.8.2. *(The documents said cargo 1.96 / node 24 / npm 11.)*
...
**O-1…O-5 are all OPEN and none needs an Owner-minted artifact.** Inventory: [`docs/PHASE_10_PRODUCTION_ITEMS.md`](./docs/PHASE_10_PRODUCTION_ITEMS.md). What blocks them is deployment wiring and a second principal. The one to know:
