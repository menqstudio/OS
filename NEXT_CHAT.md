...
| | |
|---|---|
| **Active PR / branch / task** | **PR #53** (`feat/windows-broker-machineproof`, base `main`, branch head `6df1a2f`, CI green) — the additive Windows LIVE governed-turn machine-proof for **task T-017**. Self-carrier; exact-head anchored by its PR-body `AUDIT_CANDIDATE_HEAD` marker. (PR #48, the Wave 3b design+impl consolidation, is now MERGED into `main`.) |
