...
> **⏭️ CURRENT ACTIVE: PR #77 · branch `docs/runbook-verified-end-to-end`** (base `main`, tip `506ecea`, task T-017).
>
...
> F-09's acceptance-CAS *lease-budget* framing is satisfied but the
> §2.5 TCB floor **F-10** has no caller, 
