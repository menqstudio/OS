...
**Last updated:** 2026-08-04 (production custody graduation + in-app agent + cockpit UX + two independent audits GREEN + GitHub Release `brops-desktop-v0.1.0`; Windows LIVE machine-proof, PR #53) · **Maintained by:** the implementer session, in the same commit as any state change.
...
| | |
|---|---|
| **Active PR / branch / task** | **PR #53** (`feat/windows-broker-machineproof`, base `main`, branch head `0442d89`, CI green) — the additive Windows LIVE governed-turn machine-proof for **task T-017**. Self-carrier; exact-head anchored by its PR-body `AUDIT_CANDIDATE_HEAD` marker. (PR #48, the Wave 3b design+impl consolidation, is now MERGED into `main`.) |
