...
**Active branch:** `t087/custody-decision` — `main` @ `a94513e`. A handoff names the merge base or `main`; a branch commit is a dead object after a squash. · **task** `floor-writer`
<!-- BANNER -->
