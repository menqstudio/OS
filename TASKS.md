...
| **T-062** | **The negative matrix's silent state.** 189 → **182** `unreviewed`: seven `NM-FRAME-*` rows established, mutation-proven; the review found `strict_loads` took `NaN` | Bro | Todo | `#219` |
