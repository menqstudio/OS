...
> **⏭️ CURRENT ACTIVE: PR #130 · branch `phase6-close`** (base `main`, tip `06e4a40`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Phase 6 closes at 10 of 10. All four pages and the dispatch service existed; the gap was the phase's own stop condition left unasserted - no desktop-held lease. Six contract cases now, checked against a whitelist of the frame's declared fields rather than a blacklist of forbidden names, and rewriting the builder to spread the assignment turns two of them red. Also identifies and fixes the flake recorded as unexplained in #129 - it was my own test from #126.
>
