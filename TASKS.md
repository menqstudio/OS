...
> **⏭️ CURRENT ACTIVE: PR #139 · branch `settle-138-and-generator-fix`** (base `main`, tip `12bf733`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Settles #138 and fixes sync_active_pr, which could emit a settled_at_main_head its own gate refuses
>
