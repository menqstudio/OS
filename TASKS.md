...
> **⏭️ CURRENT ACTIVE: PR #149 · branch `rest-fallback-for-a-graphql-outage`** (base `main`, tip `4d55527`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Repo-state and sync both fall back to REST when GraphQL is down; the refusal still stands when both fail
>
