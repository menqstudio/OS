...
> **✅ SETTLED — `main` is at `8663e78`.** Open: Also open, and deliberately not merged here: PR #112 (`design/floor-writer-service`). Start from `docs/OWNER_ACTION_REQUIRED.md`, the one page that says what is blocked and on whom.
>
> **Next:** T-026 (C.1 gate's three holes) is next, then T-029, T-030, T-031.
>
