...
|----|------|-----------|--------|-------------|
| **T-107** | **The page that says what waits on the Owner was wrong about what waits on him** - the seed was necessary and nowhere near sufficient; six Linux pieces do not exist and `trusted_verified` is unreachable by construction, each cited ◑ | Bro | Review | `#278` |
