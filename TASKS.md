...
> **⏭️ CURRENT ACTIVE: PR #147 · branch `settle-final`** (base `main`, tip `a244602`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Settles at a244602 with the carrier named — #146 carried a snapshot naming #145 and was merged past a red gate
>
