...
> **⏭️ CURRENT ACTIVE: PR #127 · branch `phase4-close`** (base `main`, tip `488b51d`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Phase 4 closes at 12 of 12, verified against the code before anything was built. Four section-D sweeps - keyboard, states, a11y, motion - plus a read of the three pages the phase owns found six user-facing defects, all now fixed and merged. The ticks carry measurements rather than assertions: 28 library exports, 25 of 28 modules on the library with the three exceptions reasoned, 42 colour tokens overridden in the light theme.
>
