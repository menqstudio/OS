...
> **⏭️ CURRENT ACTIVE: PR #135 · branch `a11y-every-page`** (base `main`, tip `a81bba9`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> The axe pass now covers all 19 routed feature surfaces in both states each, plus the shell and the command dock - 59 checks, up from 25 - instead of the six the fifth audit named. Also opens T-024 for the gap this does not close: no test in this repository loads a stylesheet, which is how A-01 shipped.
>
