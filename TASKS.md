...
>
> **Next:** Block A is closed: every eighth-audit finding a Builder can reach is done or answered. The next step is B -- an INDEPENDENT audit on this head, by a session that did not write these fixes, to decide which of the eight Builder claims become ticks
>
