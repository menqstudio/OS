...
> **⏭️ CURRENT ACTIVE: PR #156 · branch `fix/t023-custody-diagnosis`** (base `main`, tip `4c303df`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> T-023 fired a third time on PR #155; the custody refusal now names the ACE, the principal and whether it was INHERITED
>
