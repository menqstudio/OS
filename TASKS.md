...
> **⏭️ CURRENT ACTIVE: PR #143 · branch `t026-c1-gate-holes`** (base `main`, tip `8663e78`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> A-03/A-04/A-10 closed, plus a hole of my own: classname_groups had never read a plain string className
>
