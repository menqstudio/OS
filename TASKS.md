...
> **⏭️ CURRENT ACTIVE: PR #142 · branch `t028-roomreadout-honesty`** (base `main`, tip `a51ad6b`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> A-07: figures come from established() so a measured zero, a failed read and another room's data are three different things
>
