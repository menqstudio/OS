...
> **⏭️ CURRENT ACTIVE: PR #131 · branch `phase7-room-readout`** (base `main`, tip `e165255`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> Phase 7 closes at 8 of 8. Everything but one section-D component existed; the missing one was the room readout. Building it forced a distinction the readout now tests in both directions: a count the page cannot establish reads a dash, and a measured zero reads zero - because 'no handoffs happened' and 'I cannot see handoffs' are different facts.
>
