...
> **⏭️ CURRENT ACTIVE: PR #141 · branch `t025-discriminator-proof`** (base `main`, tip `b269b2a`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> A-02: the discriminator check is scoped to its own parser and a negative test is required; all five audit mutations now die
>
