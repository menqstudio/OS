...
> **✅ SETTLED — `main` is at `b269b2a`.** Open: Also open, and deliberately not merged here: PR #112 (`design/floor-writer-service`). Start from `docs/OWNER_ACTION_REQUIRED.md`, the one page that says what is blocked and on whom.
>
> **Next:** T-025 (validates() proves nothing) is next, then T-028 (RoomReadout), T-026, T-029, T-030, T-031; audit again once all seven are closed.
>
