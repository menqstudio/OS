...
> **⏭️ CURRENT ACTIVE: PR #140 · branch `t027-governed-provenance`** (base `main`, tip `7d41156`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> A-05: provenance is decided where an answer is produced and travels with it; four unstyled pill tones fixed alongside
>
