...
> **✅ SETTLED — `main` is at `694afb3`.** Open: Also open, and deliberately not merged here: PR #112 (`design/floor-writer-service`). Start from `docs/OWNER_ACTION_REQUIRED.md`, the one page that says what is blocked and on whom.
>
> **Next:** T-029 (dead CSS + the O-2 test count) and T-030 (DoD evidence over-reach) and T-031 (two fail-opens) remain.
>
