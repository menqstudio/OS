...
> **⏭️ CURRENT ACTIVE: PR #138 · branch `t024-computed-style-gate`** (base `main`, tip `b16e572`, task T-017). Also open, and not this PR's work: PR #112 on `design/floor-writer-service`.
>
> T-024's computed-style measurement (real Chromium), the sixth audit's A-01 palette fix, and A-06/A-12/A-13 closed
>
